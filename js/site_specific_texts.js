...
if(['mobilemonster.uk', 'mobilemonster.co.uk'].includes(window.location.host) || window.location.host.startsWith('mobile-monster.webflow.io')){
    ...
    let ukTexts = {
        ...
        '.page-terms-nd-conditions': `<h1 class="text-main-heading">Terms &amp; Conditions<br></h1><img src="https://cdn.prod.website-files.com/6295ec8d6adf7dabeda41909/62cffbe53a1a6110da9d9527_why-recycle.jpg" loading="lazy" alt="" class="image-89"><p class="normal-text">Thank you for participating in the Mobile Monster Cash-Back Offer.</p><p class="normal-text">By submitting your phone or device, you agree to the following Terms & Conditions outlined below.</p>
            ...
            <li>All quotes provided are indicative only and subject to physical inspection of the device upon receipt. We reserve the right to revise or cancel quotes in the event of pricing errors, incorrect condition description, or system glitches.</li>
            <li>No binding contract is formed until we have received and inspected the device and confirmed the final price in writing</li>
            <li>In the event of an obvious or typographical pricing error, we reserve the right to cancel or revise any order prior to final confirmation, even if the customer has submitted a device or completed the order form.</li>
...
if(['mobilemonster.co.nz'].includes(window.location.host)){
    ...
    let nzTexts = {
        ...
        ".nz-url": "https://mobilemonster.co.nz/",
        ...
        ".state-feild": `<option value="NZ-NTL">NZ-NTL</option><option value="NZ-AUK">NZ-AUK</option><option value="NZ-WKO">NZ-WKO</option><option value="NZ-BOP">NZ-BOP><option value="NZ-GIS">NZ-GIS</option><option value="NZ-HKB">NZ-HKB</option><option value="NZ-TKI">NZ-TKI</option><option value="NZ-MWT">NZ-MWT</option><option value="NZ-WGN">NZ-WGN</option><option value="NZ-TAS">NZ-TAS</option><option value="NZ-NSN">NZ-NSN</option><option value="NZ-MBH">NZ-MBH</option><option value="NZ-WTC">NZ-WTC</option><option value="NZ-CAN">NZ-CAN</option><option value="NZ-OTA">NZ-OTA</option><option value="NZ-STL">NZ-STL</option>`,
    }
