...
const businessDays = isUKDomain ? '1 business day' : isNZdomain ? '1 business day' : '3-5 business days';
...
if(hks_flow_element){
  ...
  <g id="Group_59" data-name="Group 59" transform="translate(-412 -31)">
    ...
    <text id="We_know_that_the_information_on_your_device_is_sensitive_so_we_take_extra_steps_to_make_sure_your_device_is_erased_and_your_personal_data_is_removed_from_any_device_we_receive." data-name="We know that the information on your device is sensitive, so we take 
extra steps to make sure your device is erased and your personal 
data is removed from any device we receive." transform="translate(710 75)" font-size="14" font-family="OpenSans, Open Sans"><tspan x="0" y="15">We know that the information on your device is sensitive,</tspan><tspan y="15" xml:space="preserve" font-family="OpenSans-Bold, Open Sans" font-weight="700"> so we take </tspan><tspan font-family="OpenSans-Bold, Open Sans" font-weight="700"><tspan x="0" y="34">extra steps to make sure your device is erased and your personal </tspan><tspan x="0" y="53">data is removed from any device we receive.</tspan></tspan></text>
    <text id="During_our_testing_procedure_our_testing_team_will_factory_reset_any_device_we_receive_twice_once_at_the_beginning_at_once_at_the_end._This_process_ensures_that_your_data_is_removed_before_we_test_the_device." data-name="During our testing procedure, our testing team will factory reset any 
device we receive twice, once at the beginning at once at the end. This 
process ensures that your data is removed before we test the device." transform="translate(710 156)" font-size="14" font-family="OpenSans, Open Sans"><tspan x="0" y="15">During our testing procedure, our testing team will factory reset any </tspan><tspan x="0" y="34">device we receive twice, once at the beginning at once at the end. This </tspan><tspan x="0" y="53">process ensures that your data is removed before we test the device.</tspan></text>
