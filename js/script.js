...
window.addEventListener('load', function() {
    ...
    if($('.phone_condition_box').length > 0) {
        ...
        try {
            var workingPrice = $('.condition_working').find('h2.amount_text').html();
...
function reSyncUpdatePrices() {
    ...
    if(getSelectedPrice()) {
        ...
        setTimeout(function() {
            ...
            var brandNewPrice = $('.condition_brandnew').find('h2.amount_text').html();
            ...
            var newPrice = $('.condition_new').find('h2.amount_text').html();
            var workingPrice = $('.condition_working').find('h2.amount_text').html();
            var deadPrice = $('.condition_dead').find('h2.amount_text').html();
...
function getPhoneCondition() {
    ...
    if( $('.new_active').length > 0 && $('.new_active').css('display') != 'none') {
        phoneCondition = 'As New';
    }
    
    if( $('.brandnew_active').length > 0 && $('.brandnew_active').css('display') != 'none') {
        phoneCondition = 'Brand New';
    }

    if( $('.working_active').length > 0 && $('.working_active').css('display') != 'none') {
        phoneCondition = 'working';
    }

    if( $('.dead_selected').length > 0 && $('.dead_selected').css('display') != 'none') {
        phoneCondition = 'Dead';
    }
